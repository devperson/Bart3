...
namespace DemoApp1.iOS
{
	public partial class PlayerViewController : UIViewController
	{
        ...
        {
            this._player.Pause();
            _player.RemoveObserver(this, (NSString)"rate");
            this.removeTimeObserverFromPlayer();
            _playerItem.RemoveObserver(this, (NSString)"status");
            NSNotificationCenter.DefaultCenter.RemoveObserver(this, AVPlayerItem.DidPlayToEndTimeNotification, _playerItem);
            this._playerLayer.RemoveFromSuperLayer();
            this._player = null;
            this.playerView.RemoveFromSuperview();            
        }
    }
}
